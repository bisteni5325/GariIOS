...
- (void)viewDidLoad
{
    ...
    NSString *totalLbl1 = localizeString(@"Vas a recibir ");
    NSString *totalLbl2 = localizeString(@"Gari Coins!");
    ...
    [self.startBtn setTitle:localizeString(@"EMPIEZA AHORA") forState:UIControlStateNormal];
    
    self.moneyImg.image = [UIImage imageNamed:@"money_rewards_big"];
    
    self.additionalLbl.text = localizeString(@"Recibe recompensas por buenos hábitos de manejo, además de ahorrar en gasolina y costos de mantenimiento.");
}
