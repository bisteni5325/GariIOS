...
- (void)viewDidLoad
{
    ...
    _driveCoinsMainSegmentView = [[DriveCoinsSegmentView alloc] initWithItems:@[localizeString(@"GARI COINS"),
    ...
    _daysSegmentView = [[DaysCoinsSegmentView alloc] initWithItems:@[localizeString(@"TOTAL"),
                                                            localizeString(@"DÍA"),
                                                            localizeString(@"ESTE MES"),
                                                                localizeString(@"MES ANTERIOR")] andNormalFontColor:[Color darkGrayColor] andSelectedColor:[Color darkGrayColor43] andLineColor:[Color officialMainAppColor] andFrame:CGRectMake(10, 0, self.daysSegmentBackView.frame.size.width-20, self.daysSegmentBackView.frame.size.height)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        streakCell.mainTitleLbl.text = @"Viajes sin aceleración agresiva";
        ...
        streakCell.mainTitleLbl.text = @"Viajes sin frenado agresivo";
        ...
        streakCell.mainTitleLbl.text = @"Viajes sin giros agresivos";
        ...
        streakCell.mainTitleLbl.text = @"Viajes sin exceso de velocidad";
        ...
        streakCell.mainTitleLbl.text = @"Viajes sin distracción por celular";
