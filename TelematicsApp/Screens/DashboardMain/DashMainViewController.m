...
- (void)setAccident {
    self.tipAdviceLbl.text = @"Tu estilo de manejo influye los gastos en gasolina, llantas y frenos. Mejora tu forma de conducir y genera ahorros.";
}
...
- (void)setupEcoDemoBlock {
    ...
    [self.mapDemo_permissBtn setAttributedTitle:[self createOpenAppSettingsLblImgBefore:@"Revisa los permisos de tu app \u2B95"] forState:UIControlStateNormal];
    ...
    self.demo_tipAdviceLbl.text = @"Tu estilo de manejo influye los gastos en gasolina, llantas y frenos. Mejora tu forma de conducir y genera ahorros.";
}
...
- (NSMutableAttributedString*)createOpenAppSettingsLblImgBefore:(NSString*)text {
    if IS_OS_12_OR_OLD
        text = @"Revisa los permisos de tu app";
    NSTextAttachment *imageAttachment = [[NSTextAttachment alloc] init];
