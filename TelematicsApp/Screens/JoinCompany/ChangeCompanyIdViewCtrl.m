...
- (void)setupView {
    self.mainCompanyIdLbl.text = localizeString(@"Unirte a un grupo");
    self.mainTxtLbl.text = localizeString(@"Ingresa el código de tu grupo");
    ...
    self.companyIdField.placeholder = localizeString(@"Código");
    ...
    [self.saveBtn setTitle:localizeString(@"UNIRTE") forState:UIControlStateNormal];
