...
- (void)runCheckingFeedDemoBlock {
    ...
    self.feedDemoMainLbl.text = [NSString stringWithFormat:@"Para mostrar tus viajes\nmaneja %.0f %@", reqDst, kmLocalize];
    ...
    self.feedDemoCheckAppPermissLbl.attributedText = [self createVerifedLabelAttentionImgBefore:localizeString(@" Revisa los persisos de tu app   \u2B95")];
